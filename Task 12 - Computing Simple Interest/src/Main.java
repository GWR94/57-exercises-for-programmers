...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double amount = (calculateAmount(pricipal, interest, years));
        BigDecimal finalAmount = new BigDecimal(amount);
        finalAmount = finalAmount.setScale(2, BigDecimal.ROUND_DOWN);
        System.out.println("After " + years + " years, at an interest of " + interest*100 + "%, the investment will be worth £" +
                finalAmount);
}
    ...
    private static double calculateAmount(double principal, double interest, int years) {
        return principal * (1 + (years*interest));
    }
}
