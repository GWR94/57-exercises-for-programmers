...
public class Main {
    ...
    private static double calculateAmount(double principal, double interest, int years, int compounded) {
        return principal * Math.pow((1 + (interest/compounded)), (years*compounded));
    }
}
